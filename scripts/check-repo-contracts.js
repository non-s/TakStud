...
if (exists(".github/workflows/firebase-deploy.yml")) {
  ...
  for (const token of ["Inspect Firebase credentials", "google-github-actions/auth@v3", "SERVICE_ACCOUNT_JSON", "steps.firebase-preflight.outputs.deploy == 'true'", "firestore.rules", "firestore.indexes.json", "firebase-tools@latest deploy --only firestore:rules,firestore:indexes"]) {
